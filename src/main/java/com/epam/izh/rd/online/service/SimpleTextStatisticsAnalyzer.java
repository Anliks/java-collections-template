...
public class SimpleTextStatisticsAnalyzer implements TextStatisticsAnalyzer {
    ...
    public Map<String, Integer> countNumberOfWordsRepetitions(String text) {
        ...
        List<String> ListWords = getWords(text);
        for(String word : ListWords) {
            int sumWords = Collections.frequency(ListWords, word);
            wordsMap.put(word, sumWords);
        }
        return wordsMap;
    }
    ...
    public List<String> sortWordsByLength(String text, Direction direction) {
        List<String> listWords = getWords(text);
        listWords.sort((o1, o2) -> direction == Direction.ASC ? o1.length() - o2.length() : o2.length() - o1.length());
        return listWords;
    }
}
